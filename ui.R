  ...
  dashboardBody(
    ...
    tabItems(
            ...
            tabsetPanel(
              ...
              tabPanel(
                ...
                box(
                  ...
                  enrichmentControlsUI(
                    prefix = "ora", button_id = "ora_enrich_button",
                ...
                oraPlotsUI(),
                resultsTableUI(
                  title = "ORA Results Table", output_id = "ego_table",
              ...
              tabPanel(
                ...
                box(
                  ...
                  status = "primary", solidHeader = TRUE,
                  enrichmentControlsUI(
                    prefix = "gsea", button_id = "gsea_enrich_button",
      ...
      tabItem(
          ...
          fluidRow(
            column(
              ...
              div(
                ...
                tags$span(icon("info-circle"),
                  id = "pathway_enrichment_method_info",
                  style = "cursor: pointer; margin-left: 5px;"
                )
              ),
              bsTooltip(
            ...
            column(
              9,
              enrichmentControlsUI(
                prefix = "pathway", button_id = "pathway_enrich_button",
        ...
        pathwayPlotsUI(),
        resultsTableUI(
          title = "Pathway Enrichment Results", output_id = "pathway_table",
